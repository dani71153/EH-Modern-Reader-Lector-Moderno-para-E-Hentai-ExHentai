...
(function() {
  ...
  async function resolveData() {
    ...
    dataPromise = (async () => {
      ...
      // Obtener galleries/{id}.js directamente para evitar el bloqueo de CSP de la página en scripts en línea.
      for (let i = 0; i < 4; i++) {
        try {
  ...
  function addLaunchButton() {
    ...
    // Si la página de lector o el contenedor de botón no existe, usar botón flotante como respaldo
  ...
  function interceptClicks() {
    ...
    // Clic en miniatura: generalmente es /reader/{gid}.html#N
  ...
  function autoLaunchOnReaderPage() {
    ...
    // La página de lector entra automáticamente al lector moderno; el usuario puede cerrar y cambiar manualmente
